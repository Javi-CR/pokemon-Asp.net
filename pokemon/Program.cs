...
// Configurar la identidad y ajustar los requisitos de la contrase�a
builder.Services.AddDefaultIdentity<IdentityUser>(options =>
{
    options.SignIn.RequireConfirmedAccount = true;
    // Ajusta los requisitos de la contrase�a seg�n tus necesidades
    ...
    foreach (var userInfo in adminUsers)
    {
        ...
        if (user == null)
        {
            user = new IdentityUser
            {
                ...
                EmailConfirmed = true // Confirmar el correo electr�nico al crear el usuario
            };
